/** Test Exprs.
 * See http://www.radford.edu/itec380/2014fall/Homeworks/Project/
 *
 * Meant to cover most syntax situations for Q0-Q3.
...
public class ExprTest extends junit.framework.TestCase {
    ...
    protected void setUp() {
      ...
      //,new Pair<String,Object>( "7.0", 7 )  // parseString("7.0").toString() return "7", not "7.0".
        ...
        /* *** Q1 tests: *** */
        /* Uncomment these tests, once `%%%` is implemented:
         
        ,new Pair<String,Object>( "(3 %%% 4)", 3)
        ,new Pair<String,Object>( "((5 add 6) %%% 3)", 2)
        ,new Pair<String,Object>( "(8.1 %%% 3)", 2.1)      
        ,new Pair<String,Object>( "(8 %%% 3.1)", 1.8)    
        ,new Pair<String,Object>( "(-8.1 %%% 3)", 0.9)     
        ,new Pair<String,Object>( "(-8 %%% 3.1)", 1.3)    
        ,new Pair<String,Object>( "(8.1 %%% -3)", -0.9)    
        ,new Pair<String,Object>( "(8 %%% -3.1)", -1.3)  
        ,new Pair<String,Object>( "(-8.1 %%% -3)", -2.1)
        ,new Pair<String,Object>( "(-8 %%% -3.1)", -1.8)
        ,new Pair<String,Object>( "(8 %%% 2)", 0)
        ,new Pair<String,Object>( "(-8 %%% 2)", 0)
        ,new Pair<String,Object>( "(8 %%% -2)", 0)
        ,new Pair<String,Object>( "(-8 %%% -2)", 0)
        ,new Pair<String,Object>( "(8 %%% 3)", 2)
        ,new Pair<String,Object>( "(-8 %%% 3)", 1)
        ,new Pair<String,Object>( "(8 %%% -3)", -1)
        ,new Pair<String,Object>( "(-8 %%% -3)", -2)
